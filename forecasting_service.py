...
class ForecastingService:
    ...
    def save_forecast_to_mongo(rune_name, forecast_data):
        try:
            ...
            logging.info(f"Forecast data saved to MongoDB successfully for rune: {rune_name}")
        except Exception as e:
            logging.error(f"Error saving forecast data to MongoDB for rune {rune_name}: {e}")
